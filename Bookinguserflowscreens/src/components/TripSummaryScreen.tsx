...
import { ArrowLeft, ChevronDown, ChevronUp, Check, CreditCard, Lock, Phone, Mail, Calendar, Info, MessageCircle, Download, Share2, Plane, Train, Hotel } from 'lucide-react';
...
export function TripSummaryScreen({ onBack, onComplete }: TripSummaryScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col max-w-md mx-auto">
      {/* Header */}
      <div className="bg-white border-b border-[#E5E7EB] px-4 py-3 fixed top-0 left-0 right-0 z-40 max-w-md mx-auto">
        <div className="flex items-center justify-between mb-3">
          <button onClick={onBack} className="p-2 -ml-2">
            <ArrowLeft className="w-6 h-6 text-[#1F2937]" />
          </button>
          <h1 className="text-[#1F2937]">Trip Summary</h1>
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="flex-1 bg-[#E5E7EB] rounded-full h-2">
            <div className="bg-[#4AA3F2] h-2 rounded-full" style={{ width: '86%' }}></div>
          </div>
          <span className="text-sm text-[#6B7280]">Step 6 of 7</span>
        </div>
      ...
      {/* Main Content */}
      <div className="flex-1 pt-36 pb-32 px-4 overflow-y-auto">
        {/* Trip Overview Card */}
        <div className="bg-white rounded-xl p-6 shadow-sm border border-[#E5E7EB] mb-6">
          <h2 className="text-[#1F2937] mb-4">Your Christmas Markets Adventure</h2>
          ...
          <div className="space-y-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2937]">Dec 15: Fly to Prague</p>
                <p className="text-[#6B7280] text-sm">London → Prague</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2937]">Dec 15-18: Prague (3 nights)</p>
                <p className="text-[#6B7280] text-sm">Hotel Golden Well</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2937]">Dec 18: Train to Vienna</p>
                <p className="text-[#6B7280] text-sm">4h 15min journey</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2937]">Dec 18-21: Vienna (3 nights)</p>
                <p className="text-[#6B7280] text-sm">Hotel Sacher Wien</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2937]">Dec 21: Train to Munich</p>
                <p className="text-[#6B7280] text-sm">4h 30min journey</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2937]">Dec 21-22: Munich (1 night)</p>
                <p className="text-[#6B7280] text-sm">Airport Hotel Regent</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2937]">Dec 22: Fly home</p>
                <p className="text-[#6B7280] text-sm">Munich → London</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[#E5E7EB]">
            <div>
              <p className="text-[#6B7280] text-sm">Travelers</p>
              <p className="text-[#1F2937]">3 Adults</p>
            </div>
            <div className="text-right">
              <p className="text-[#6B7280] text-sm">Duration</p>
              <p className="text-[#1F2937]">8 days, 7 nights</p>
            </div>
          </div>
        </div>
