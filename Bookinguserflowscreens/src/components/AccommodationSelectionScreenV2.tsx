...
import { ArrowLeft, Map, List, SlidersHorizontal, Star, Wifi, Coffee, MapPin, Clock, TrendingUp, ChevronDown, ChevronUp, Users, Calendar } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col max-w-md mx-auto">
      ...
      <div className="bg-white border-b border-[#E5E7EB] px-4 py-3 fixed top-0 left-0 right-0 z-40 max-w-md mx-auto">
        <div className="flex items-center justify-between mb-3">
          ...
          <h1 className="text-[#1F2937]">Where to Stay</h1>
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="flex-1 bg-[#E5E7EB] rounded-full h-2">
            <div className="bg-[#4AA3F2] h-2 rounded-full" style={{ width: '71%' }}></div>
          </div>
          <span className="text-sm text-[#6B7280]">Step 5 of 7</span>
        </div>

        {/* Filter Bar */}
        <div className="flex items-center gap-2 -mx-4 px-4 overflow-x-auto pb-2 scrollbar-hide">
      ...
      {/* Main Content */}
      <div className="flex-1 pt-44 pb-72 px-4 overflow-y-auto">
        {/* Smart Insights */}
        {showSmartInsights && (
