...
import { ArrowLeft, Lightbulb, ChevronDown, ChevronUp, Check, X, SlidersHorizontal } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] pb-24">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white border-b border-[#E5E7EB] z-40">
        <div className="flex items-center justify-between px-4 py-4 max-w-md mx-auto">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-[#1F2937]">Transportation</h1>
          </div>
          <div className="w-6" />
        </div>
        ...
        <div className="px-4 pb-3 max-w-md mx-auto">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[#6B7280]">Step 4 of 7</span>
            <span className="text-[#6B7280]">57%</span>
          </div>
          <div className="w-full bg-[#E5E7EB] rounded-full h-2">
            <div className="bg-[#4AA3F2] h-2 rounded-full transition-all duration-300" style={{ width: '57%' }} />
          </div>
        </div>

        {/* Tabs */}
        <div className="px-4 py-3 max-w-md mx-auto bg-white border-b border-[#E5E7EB]">
        ...
        {/* Route Summary */}
        <div className="px-4 py-3 max-w-md mx-auto border-b border-[#E5E7EB]">
      ...
      <div 
        ...
        style={{ 
          paddingTop: activeTab === 'flights' ? '332px' : '332px',
          paddingLeft: '16px',
          paddingRight: '16px'
        }}
      >
