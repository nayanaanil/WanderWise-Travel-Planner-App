...
import { ArrowLeft, GripVertical, X, Plus, Plane, PiggyBank, Backpack, Clock, Info, Minus } from 'lucide-react';
      ...
      <header className="fixed top-0 left-0 right-0 bg-white border-b border-[#E5E7EB] z-40">
        <div className="flex items-center justify-between px-4 py-4 max-w-md mx-auto">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-[#1F2937]">Build Your Route</h1>
          </div>
          <button className="px-3 py-1.5 text-[#4AA3F2] hover:bg-[#EFF6FF] rounded-lg transition-colors">
            Save Draft
          </button>
        </div>
        ...
        <div className="px-4 pb-3 max-w-md mx-auto">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[#6B7280]">Step 3 of 7</span>
            <span className="text-[#6B7280]">43%</span>
          </div>
          <div className="w-full bg-[#E5E7EB] rounded-full h-2">
            <div className="bg-[#4AA3F2] h-2 rounded-full transition-all duration-300" style={{ width: '43%' }} />
          </div>
        </div>
      </header>
