...
import { Star, MapPin, ChevronRight, Search, ChevronLeft } from 'lucide-react';
    ...
    <div className="min-h-screen pt-16 pb-20 bg-gradient-to-br from-[#FFF5F4]/30 via-white to-[#FFF5F4]/20">
      <div className="max-w-md mx-auto px-6 py-6">
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <div className="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center text-sm">✓</div>
          <div className="w-12 h-1 bg-black rounded"></div>
          <div className="w-8 h-8 rounded-full bg-[#FE4C40] text-white flex items-center justify-center text-sm">3</div>
        </div>
