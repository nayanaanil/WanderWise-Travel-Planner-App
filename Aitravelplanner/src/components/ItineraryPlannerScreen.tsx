...
export function ItineraryPlannerScreen({ bookedItems = [], onAddToTrip, tripParams, onSave }: ItineraryPlannerScreenProps) {
  ...
  const [expandedStyle, setExpandedStyle] = useState<string | null>('balanced');
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="px-4 pt-4 flex items-center justify-between">
          <button 
            ...
            className="flex items-center gap-2 text-gray-600 hover:text-[#205A5D] transition-colors"
          >
          ...
          {onSave && (
            <button
              onClick={onSave}
              className="flex items-center gap-2 px-4 py-2 bg-[#FE4C40] text-white rounded-lg hover:bg-[#E63C30] transition-colors text-sm"
            >
              <span>⭐</span>
              <span>Save</span>
            </button>
        ...
        <div className="px-4 py-4 border-b border-gray-100">
          <div className="mb-3">
            <h1 className="text-xl text-gray-900 mb-2">
              {calculateDays()} {calculateDays() === 1 ? 'Day' : 'Days'} in {tripParams?.destination || 'Your Destination'}
            </h1>
        ...
        {activeTab === 'itinerary' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="px-4 py-4 border-r border-gray-100 overflow-y-auto max-h-[calc(100vh-200px)]">
            ...
            <div className="mb-6 pt-8 border-t border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <button onClick={() => router.push("/bookings")} className="w-full py-4 bg-[#FE4C40] text-white rounded-xl hover:bg-[#E63C30] transition-all flex items-center justify-center gap-2 shadow-md hover:shadow-lg mt-4">
          ...
          <div className="relative bg-gray-100 min-h-[400px] lg:min-h-[calc(100vh-200px)] hidden lg:block">
            {/* Map Header */}
            ...
            <div className="relative w-full h-full bg-gradient-to-br from-blue-100 via-green-50 to-gray-100">
              {/* Simulated Map */}
                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute top-1/4 left-1/3 transform -translate-x-1/2 -translate-y-1/2">
                    <div className="relative">
                      <div className="w-8 h-8 bg-[#FE4C40] rounded-full shadow-lg flex items-center justify-center border-2 border-white">
                        <span className="text-white text-xs">1</span>
                      </div>
                      <div className="absolute top-10 left-1/2 -translate-x-1/2 bg-white px-2 py-1 rounded shadow-md text-xs whitespace-nowrap">
                        First Stop
                      </div>
                    </div>
                  </div>
                  ...
                  <svg className="absolute inset-0 w-full h-full pointer-events-none">
                    <line x1="33%" y1="25%" x2="50%" y2="33%" stroke="#205A5D" strokeWidth="2" strokeDasharray="5,5" opacity="0.5"/>
                    <line x1="50%" y1="33%" x2="67%" y2="67%" stroke="#205A5D" strokeWidth="2" strokeDasharray="5,5" opacity="0.5"/>
                  </svg>
                </div>
              </div>
        ...
        {/* Map Tab Content */}
        {activeTab === 'map' && (
          <div className="px-4 py-6 h-[calc(100vh-200px)]">
