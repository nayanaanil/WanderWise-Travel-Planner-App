    ...
    if (isHydrated && city) {
      ...
      saveTripState({
        destination: {
          ...
          city: city.type === 'city' ? city : undefined, // Only set city object for actual cities
          seasonalityAnchor,
        },
      });
    }
  ...
  return (
    <div className="min-h-screen pb-0 flex flex-col">
      <StepHeader
        ...
        onBack={onBack}
      />
      <div className="flex-1 max-w-md mx-auto w-full px-6 py-6 pt-[120px] pb-[15px] bg-gradient-to-br from-orange-50 via-pink-50 to-orange-50 rounded-t-2xl rounded-b-none">
        {/* Header - Premium */}
